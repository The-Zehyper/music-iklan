var Profile = {
    render() {
        ...
        <div class="pt-6 px-4 text-center">
            ...
            <h1 class="text-3xl font-black chrome-text mb-1">Alfath</h1>
            ...
            <div class="glass rounded-2xl p-5 max-w-sm mx-auto space-y-3 text-left mb-6">
                ...
                <div class="flex justify-between"><span class="text-white/70 text-sm">Nama</span><span class="text-white font-medium text-sm">Alfath</span></div>
            ...
            <div class="glass rounded-2xl p-5 max-w-sm mx-auto space-y-4 text-left mb-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-white font-bold text-sm">Alfath</span>
                    </div>
                </div>
            ...
            <a href="https://whatsapp.com/channel/0029VbFXLg96LwHhyiQxLy1a" target="_blank" class="block w-full max-w-sm mx-auto btn-chrome font-bold py-4 rounded-full active:scale-95 transition-all text-center flex items-center justify-center gap-2">
